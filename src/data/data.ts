    ...
    },
    {
      ...
      responsibilities: {
        ru: [
          ...
          'Разработка системы подписок с интеграцией Google Play Billing, App Store IAP, ВТБ и ЮKassa',
        ...
        en: [
          ...
          'Developing subscription system with Google Play Billing, App Store IAP, VTB, and YooKassa',
      ...
      projects: [
        {
          ...
          links: [
            ...
            {
              label: 'Google Play',
              url: 'https://play.google.com/store/apps/details?id=com.intellera.reserve',
            },
          ],
          period: '2025',
        },
